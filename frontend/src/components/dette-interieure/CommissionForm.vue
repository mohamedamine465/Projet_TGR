<template>
  <div class="form-container">
    <div class="form-card">
      <h3 class="form-title">Nouveau Bordereau (Commission)</h3>
      <p class="form-subtitle">Création d'un bordereau d'émission de commissions.</p>
      ...
      <form @submit.prevent="submitForm" class="modern-form">
        <div class="form-grid">
          ...
          <div class="form-group">
            <BaseInput 
              id="montantBordereau" 
              label="Montant du bordereau (MAD)" 
              type="number" 
              step="0.01" 
              min="0" 
              placeholder="Ex: 15000.00" 
              v-model="formData.montantBordereau" 
              required 
            />
          </div>
        </div>
